...
function startGame() {
    myGamePiece = new component(30, 30, "silver", 10, 120);   /*definisanje predmeta sirina, visina, boja, udaljenost od lijevog coska(100), odakle ce poceti predmet(120)*/
...
var myGameArea = {
    ...
    start : function() {
        ...
        this.frameNo = 0;
        this.interval = setInterval(updateGameArea, 15);	/*interval updajta*/
        },
    clear : function() {
